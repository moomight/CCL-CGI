...
GLOBAL_PPI_H5_DIR = os.getcwd() + "/h5/global_ppi.h5"
...
cell_type = ['T cells', 'Smooth muscle cells', 'Plasmacytoid dendritic cells', 'Plasma cells', 'Pericytes',
             'Pancreatic stellate cells', 'NK cells', 'Neutrophils', 'Neurons', 'Myoepithelial cells', 'Monocytes',
             'Macrophages', 'Luminal epithelial cells', 'Keratinocytes', 'Hepatocytes', 'Goblet cells',
             'Gamma (PP) cells', 'Fibroblasts', 'Enteroendocrine cells', 'Enterocytes',
             'Endothelial cells', 'Ductal cells', 'Dendritic cells', 'Delta cells', 'Cholangiocytes', 'Beta cells',
